            ...
            <div className="p-6 md:p-8 rounded-lg max-w-4xl mx-auto">
                ...
                >
                    ...
                    <button
                        type="submit"
                        disabled={processing}
                        className="w-full mt-14 px-3 md:px-8 py-3 bg-gradient-to-r from-red-600 to-red-800 text-white text-xs md:text-lg font-bold uppercase rounded-xl shadow-lg hover:shadow-red-500/50 transition duration-300 ease-in-out disabled:opacity-50"
                    >
